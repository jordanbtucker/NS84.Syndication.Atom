...
namespace NerdSince1984.Syndication.Atom
{
  ...
  public class AtomIcon : AtomUriNode
  {
    ...
    /// <value>An <see cref="XName"/> representing the name of the underlying element. For <see cref="AtomIcon"/>, this value is <see cref="AtomFeed.AtomNamespace"/> + "icon".</value>
