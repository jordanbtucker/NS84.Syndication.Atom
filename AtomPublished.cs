...
namespace NerdSince1984.Syndication.Atom
{
  ...
  public class AtomPublished : AtomDateNode
  {
    ...
    /// <returns>An <see cref="XName"/> representing the name of the underlying element. For <see cref="AtomPublished"/>, this value is <see cref="AtomFeed.AtomNamespace"/> + "published".</returns>
