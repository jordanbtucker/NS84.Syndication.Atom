...
namespace NS84.Syndication.Atom
{
  ...
  public class AtomTitle : AtomTextNode
  {
    ...
    /// <value>An <see cref="XName"/> representing the name of the underlying element. For <see cref="AtomTitle"/>, this value is <see cref="AtomFeed.AtomNamespace"/> + "title".</value>
