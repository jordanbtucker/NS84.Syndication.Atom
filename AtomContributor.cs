...
namespace NerdSince1984.Syndication.Atom
{
  ...
  public class AtomContributor : AtomPersonNode
  {
    ...
    /// <returns>An <see cref="XName"/> representing the name of the underlying element. For <see cref="AtomContributor"/>, this value is <see cref="AtomFeed.AtomNamespace"/> + "contributor".</returns>
